...
const Registro = () => {
    ...
    useEffect(() =>{
        ...
        register("direccion",{ required: { value: true, message: 'La dirección es requerida' }})
        register("telefono",{ required: {value: true, message: 'El teléfono es requerido'},
            ...
            <div className="limiter">
                <div className="container-login100">
                    <div className="wrap-login100">
                        <form onSubmit={handleSubmit(_onSubmit)} encType="multipart/form-data" className="login100-form validate-form" style={{paddingTop: 40}}>
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                <textarea name="descripcion"
                                    className="input100"
                                    onChange={e =>{ _onChangeInput(e); setValue("descripcion", e.target.value) }}
                                ></textarea>
                                <span className="focus-input100"></span>
                                <span className="label-input100">Descripción de la empresa</span>
                            </div>
                            {errors.descripcion && <small style={{color: 'red'}}>{errors.descripcion?.message}</small>}
                            <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                <input className="input100" type="email" name="correo"
                                    onChange={e =>{ _onChangeInput(e); setValue("correo", e.target.value) }}
                                />
                                <span className="focus-input100"></span>
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                <input className="input100" type="text" name="direccion"
                                    onChange={e =>{ _onChangeInput(e); setValue("direccion", e.target.value) }}
                                />
                                <span className="focus-input100"></span>
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                <input className="input100" type="tel" name="telefono"
                                    onChange={e =>{ _onChangeInput(e); setValue("telefono", e.target.value) }}
                                />
                                <span className="focus-input100"></span>
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Password is required">
                                <input className="input100" type="password" name="password"
                                    onChange={e =>{ _onChangeInput(e); setValue("password", e.target.value) }}
                                />
                                <span className="focus-input100"></span>
                            ...
                            <div className="wrap-input100 validate-input" data-validate="Valid email is required: ex@abc.xyz">
                                <input className="input100 has-val"  type="file" name="logo"
                                    onChange={e => {_onChangeImagePreview(e); setValue("logo",e.target.files)}}
                                />
                                <span className="focus-input100"></span>
                                <span className="label-input100" style={{fontSize: 15}}>Logo</span>
                            </div>
                            ...
                            {uploadedImage !== '' ? (
                                <div style={{marginBottom: 10, display: 'flex', justifyContent: 'center', alignItems: 'center'}}>
                                    <img style={{width:'50%'}} src={uploadedImage} alt="uploadedImage"/>
                                </div>
                            ): null}
